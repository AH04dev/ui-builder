...
export default function Orb({
  ...
  const frag = /* glsl */ `
    ...
    const vec3 baseColor1 = vec3(0.3, 0.4, 0.95);  // Blue primary
    const vec3 baseColor2 = vec3(0.45, 0.3, 0.85);   // Purple accent
    const vec3 baseColor3 = vec3(0.2, 0.25, 0.5);   // Dark blue-purple for depth
